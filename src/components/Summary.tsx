...
const Summary = (props: PropsSummary) => {
    return (
        <div className="top-0 left-0 w-full py-4">
            <div
                className="sm:hidden group w-full rounded-lg bg-purple-500 p-4 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_#2196f3] mb-4"
            >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
                <div
                    className="hidden sm:block group w-full rounded-lg bg-purple-500 p-4 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_#2196f3]"
                >
                    <p className="text-white text-2xl font-bold">
                        { props.name }
                    </p>
                ...
                <div
                    className="group w-full rounded-lg bg-gray-400 dark:bg-slate-900 p-4 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_rgb(244,67,54)]"
                >
                    <p className="text-white text-2xl font-bold">
                ...
                <div
                    className="group w-full rounded-lg bg-purple-500 sm:bg-gray-400 sm:dark:bg-slate-900 p-4 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_rgb(244,67,54)]"
                >
                    <p className="text-white text-2xl font-bold">
                ...
                <div
                    className="group w-full rounded-lg bg-slate-900 sm:bg-purple-500 p-4 transition relative duration-300 cursor-pointer hover:translate-y-[3px] hover:shadow-[0_-8px_0px_0px_#2196f3]"
                >
                    <p className="text-white text-2xl font-bold">
